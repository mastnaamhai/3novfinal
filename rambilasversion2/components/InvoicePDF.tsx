    ...
    return (
        <div id="invoice-pdf" className="bg-white p-4 text-base font-sans" style={{ width: INVOICE_WIDTH, minHeight: INVOICE_HEIGHT, fontFamily: 'sans-serif', lineHeight: '1.3', margin: '0 auto', overflow: 'visible', boxSizing: 'border-box' }}>
            <style>{`
                ...
                #invoice-pdf {
                    width: ${INVOICE_WIDTH} !important;
                    min-height: ${INVOICE_HEIGHT} !important;
                    transform: none; /* Transform controlled by parent wrapper in InvoicePDF component */
                ...
                .invoice-table {
                    ...
                    font-size: ${Math.max(12, 20 * tableScale)}px;
                    table-layout: fixed;
                    border-collapse: collapse;
                    transform: ${tableScale < 1.0 ? `scale(${tableScale})` : 'none'};
                    transform-origin: top left;
                    width: ${tableScale < 1.0 ? `${100 / tableScale}%` : '100%'};
                    max-width: 100%;
                ...
                .invoice-table th,
                .invoice-table td {
                    padding: ${Math.max(8, 10 * tableScale)}px ${Math.max(4, 6 * tableScale)}px;
                ...
                .charges-table th,
                .charges-table td {
                    padding: ${Math.max(6, 10 * tableScale)}px ${Math.max(3, 6 * tableScale)}px !important;
                    font-size: ${Math.max(12, 20 * tableScale)}px !important;
                ...
                @media print {
                    ...
                    /* Ensure single box is visible in print - edge to edge with minimal padding */
                    .invoice-single-box {
                        border: 2px solid #000 !important;
                        background-color: #ffffff !important;
                        page-break-inside: avoid !important;
                        padding: 8px !important; /* Minimal padding for readability while maximizing space */
                        width: 100% !important;
                        box-sizing: border-box !important;
                    }
                    ...
                    /* Ensure tables fit properly in landscape - NO TRANSFORMS in print, use full width */
                    .invoice-table {
                        transform: none !important;
                        width: 100% !important;
                        max-width: 100% !important;
                    ...
                    .invoice-table th,
                    .invoice-table td {
                        padding: ${Math.max(8, 10 * tableScale)}px ${Math.max(4, 6 * tableScale)}px !important;
                        font-size: ${Math.max(12, 20 * tableScale)}px !important;
                    ...
                    /* Reset charges table transforms in print, use full width */
                    .charges-table {
                        transform: none !important;
                        width: 100% !important;
                        max-width: 100% !important;
                    ...
                    .charges-table th,
                    .charges-table td {
                        padding: ${Math.max(6, 10 * tableScale)}px ${Math.max(4, 6 * tableScale)}px !important;
                        font-size: ${Math.max(11, 20 * tableScale)}px !important;
                        ${hideTableBorders ? 'border: none !important;' : ''}
                    }
            ...
            <div className="w-full" style={{ width: '100%' }}>
                ...
                <div className="invoice-single-box" style={{ padding: '20px', border: '2px solid #000', width: '100%', boxSizing: 'border-box' }}>
