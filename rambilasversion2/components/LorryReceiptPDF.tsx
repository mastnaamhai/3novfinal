...
export const LorryReceiptView: React.FC<LorryReceiptViewProps> = ({ lorryReceipt, companyInfo, copyType = 'PREVIEW', hideCharges = true }) => {
    ...
    return (
        <div className="bg-white p-0 text-xs font-sans break-inside-avoid shadow-lg relative mx-auto" style={{ width: '210mm', minHeight:'297mm', fontFamily: 'Arial, sans-serif', lineHeight: '1.2' }}>
            ...
            <div className="border-2 border-black p-2 relative z-20" style={{ width: '100%', height: '100%' }}>
                {/* Header Section - Centered */}
                <div className="flex flex-col items-center justify-center mb-4 relative">
                    {/* Phone Numbers - Top Right Corner */}
                    <div className="absolute top-0 right-0 text-right text-sm whitespace-nowrap pr-2">
                    ...
                    <div className="mb-1 text-center">
                        <p className="text-xs font-semibold italic">!! Jai Bajarang Bali !!</p>
                        <p className="text-xs font-semibold italic">!! Jai Dada Nath !!</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mb-1 justify-center">
                        ...
                        {/* Company Name */}
                        <h1 className="text-2xl font-bold tracking-wide text-red-600 whitespace-nowrap">{companyInfo?.name || 'Company Name'}</h1>
                    </div>
                    
                    {/* Company Address */}
                    <p className="text-xs mb-0.5 text-center">{companyInfo?.address || 'Company Address'}</p>
                    
                    {/* Email and Website */}
                    <p className="text-xs mb-1 text-center">E-mail: {companyInfo?.email || 'email@company.com'} / Web.: {companyInfo?.website || 'www.company.com'}</p>
                </div>

                {/* Sub-Header Section - 3 Column Grid */}
                <div className="grid grid-cols-3 gap-1 mb-2">
                    {/* Left Box - Demurrage Charges */}
                    <div className="border border-black p-1 pb-3">
                ...
                <div className="grid grid-cols-5 gap-1 mb-2">
                    ...
                    <div className="col-span-3">
                        {/* Consignment Note */}
                        <div className="border border-black p-1 pb-3 mb-2">
                    ...
                    <div className="col-span-2">
                        {/* GST Payable By */}
                        <div className="border border-black p-1 pb-3 mb-1">
                ...
                <div className="grid grid-cols-12 gap-1 mb-2">
                    ...
                    <div className="col-span-8">
                        ...
                        <div className="grid grid-cols-4 text-center font-bold border-2 border-black bg-white h-[3rem]">
                        ...
                        <div className="min-h-[3rem] border-l-2 border-r-2 border-b-2 border-black bg-white">
                            {lorryReceipt.packages && lorryReceipt.packages.length > 0 ? (
                                lorryReceipt.packages.map((pkg, index) => (
                                    <div key={index} className={`grid grid-cols-4 border-b-2 border-black h-[2rem] items-center last:border-b-0 bg-white`}>
                    ...
                    {!hideCharges && (
                        <div className="col-span-4">
                            {/* Charges Header */}
                            <div className="grid grid-cols-3 text-center font-bold border-2 border-black bg-white h-[2.5rem]">
                            ...
                            <div className="min-h-[3rem] border-l-2 border-r-2 border-b-2 border-black">
                                {charges.filter(charge => charge.value > 0).map(charge => (
                                    <div key={charge.label} className="grid grid-cols-3 border-b border-black h-[1.8rem] items-center last:border-b-0 bg-white">
                            ...
                            {/* Charges Total */}
                            <div className="grid grid-cols-3 font-bold border-2 border-black bg-white">
