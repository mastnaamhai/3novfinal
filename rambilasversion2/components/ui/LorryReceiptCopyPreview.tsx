...
export const LorryReceiptCopyPreview: React.FC<LorryReceiptCopyPreviewProps> = ({
  ...
  const handleDownloadPdf = async (copyId: string) => {
    ...
    try {
      ...
      root.render(
        <div className="print-container flex flex-col items-center justify-center bg-white p-0" style={{ minHeight: '100vh' }}>
          <LorryReceiptView
            lorryReceipt={lorryReceipt}
            companyInfo={companyInfo}
  ...
  const handleDownloadAllCopies = async () => {
    try {
      ...
      root.render(
        <div className="print-container flex flex-col items-center justify-center bg-white p-0 space-y-8" style={{ minHeight: '100vh' }}>
